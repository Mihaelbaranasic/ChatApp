...
class DatotekaDAO {
    ...
    async posaljiDatoteku(posiljatelj, primatelj, nazivDatoteke, putanjaDatoteke) {
        this.baza.spojiSeNaBazu();
        ...
        await this.baza.izvrsiUpit(sql, [posiljatelj, primatelj, nazivDatoteke, putanjaDatoteke]);
        this.baza.zatvoriVezu();
    }
}
